...
namespace andibandi {
    ...
    class Program {
        static void Main(String[] args) {
            ...
            int Sa = Convert.ToInt32(Next(it));
            int Ta = Convert.ToInt32(Next(it));
            int Ua = Convert.ToInt32(Next(it));

            int Sb = Convert.ToInt32(Next(it));
            int Tb = Convert.ToInt32(Next(it));
            int Ub = Convert.ToInt32(Next(it));
